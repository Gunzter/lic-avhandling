...
\newif\ifpaperV % TPM HAS
\newif\ifpaperVI % TPM HAS
...
``\paperIItitle''.
In \emph{IEEE 6th International Workshop on Privacy and Security of Big Data, Big Data 2019, Los Angeles, USA}.
LNCS Vol. 9473, pp. 243--258, Springer. % DOI: 10.1007/978-3-319-27998-5_16
}

\newcommand{\paperIIItitle}{Object Security for the Internet of Things}
\newcommand{\paperIIIref}{%
Martin Gunnarsson, Joakim Brorsson, Francesca Palombini, Ludwig Seitz, Marco Tiloca
``\paperIIItitle''.
In \emph{Ad Hoc Networks - Special Issue on Internet of Things Security and Forensics}.
LNCS Vol. 9473, pp. 243--258, Springer. % DOI: 10.1007/978-3-319-27998-5_16
}
...
Christian Gehrmann, Martin Gunnarsson
``\paperIVtitle''.
In \emph{IEEE Transaction on Industrial Informatics}.
LNCS Vol. 9473, pp. 243--258, Springer. % DOI: 10.1007/978-3-319-27998-5_16
}

\title{Security Solutions for Constrained Devices in Cyber-Physical Systems}
%\title{Efficient Security Mechanisms for Cyber-Physical Systems}
%\title{Efficient Security Protocols for Cyber-Physical Systems}
%\title{Efficient Security Protocols for Constrained and Industrial Systems}
...
\include{papers/digital-twin/digital-twin}
\fi
